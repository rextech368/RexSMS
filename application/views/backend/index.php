		...
		<div class="chat">
					<div class="refresh">
								...
								<?php 
									...
									$select_all_messages_from_general_message_table = $this->crud_model->get_general_messages();
			...
			<div class="message-icon">
			  ...
			  <script type="text/javascript" src="<?php echo base_url(); ?>js/optimumajax.js"></script>
