...
<div class="row">
	...
	<?php echo form_open(base_url() . 'accountant/leave/create' , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
        ...
        foreach($leave as $row): ?>
            <tr>
				...
				<a href="#" onclick="showAjaxModal('<?php echo base_url(); ?>modal/popup/leave_edit/<?php echo $row['leave_id']; ?>');" 
                  ...
                  <a href="#" onclick="confirm_modal('<?php echo base_url(); ?>accountant/leave/delete/<?php echo $row['leave_id']; ?>');" 
