		...
		<div class="panel panel-info">
			...
			<div class="panel-body table-responsive">
				...
				<div class="form-group"> 
				  ...
				  <div class="form-group">
                   <label class="col-md-12" for="example-text"><?php echo get_phrase('upload_your_signature'); ?></label>
                    <div class="col-sm-12">
						<input type='file' class="form-control" name="sign" />
						<img id="blah" src="<?php echo base_url(); ?>uploads/teacher_image/teacher_<?=$row['teacher_id']?>.jpg" alt="" height="20" width="150"/>
					</div>
				</div>
