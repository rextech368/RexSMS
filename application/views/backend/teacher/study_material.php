<div class="row">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-12">
							...
							<input type="hidden" name="teacher_id" class="form-control" value="<?php echo $this->session->userdata('teacher_id');?>" name="name" / required>
                        </div>
                    </div>
					...
					$class =  $this->db->get_where('class', array('teacher_id' => $teacher))->result_array();
                    ...
                    <div class="col-sm-12">
                 	...
                 	<input type="date" name="timestamp" value="<?=date('Y-m-d')?>" class="form-control datepicker" id="example-date-input" required>
                ...
                <div class="form-group">
                 	<label class="col-md-12" for="example-text"><?php echo get_phrase('file_type');?> <b style="color:red">*</b></label>
                    <div class="col-sm-12">
				...
				<div class="form-group">
					...
					<div class="form-group">
                 	<label class="col-md-12" for="example-text"><?php echo get_phrase('select_document');?> <b style="color:red">*</b></label>
                    <div class="col-sm-12">
