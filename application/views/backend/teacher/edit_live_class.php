  ...
  <div class="row">
                    <div class="col-sm-12">
                        <div class="panel panel-default">
								...
								<a href="<?php echo site_url('teacher/live_class/'); ?>"><button type="button" class="btn btn-default btn-sm pull-right"><i class="fa fa-mail-reply-all"></i> back</button></a>
								<hr class="sep-2">
                                    
			<?php 
			$select = $this->db->get_where('live_class', array('live_class_id' => $live_class_id))->result_array();
			foreach ($select as $key => $row) : ?>					
			<?php echo form_open(base_url() . 'teacher/live_class/edit/'. $live_class_id , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
					<div class="row">
                    <div class="col-sm-6">
