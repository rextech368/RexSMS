  ...
  <div class="row">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-wrapper collapse out" aria-expanded="true">
                                <div class="panel-body">
								 ...
								 <?php echo form_open(base_url() . 'hrm/teacher/insert/' , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
					<div class="row">
                    <div class="col-sm-6">
			  ...
			  <p style="color:red">Accept zip, pdf, word, excel, rar and others</p>
					...
					<div class="form-group"> 
					 <label class="col-sm-12"><?php echo get_phrase('browse_image');?> <b style="color:red">*</b></label>        
					 <div class="col-sm-12">
...
<div class="form-group">
    <label class="col-sm-12"><?php echo get_phrase('department'); ?> <b style="color:red">*</b></label>
                    ...
                    <tbody>
                        ...
                        <tr>
                           ...
                           <?php if($teacher['role']== 2) echo 'Subject Teacher';?>
                            ...
                            <a href="<?php echo base_url();?>hrm/edit_teacher/<?php echo $teacher['teacher_id'];?>/TeacherName=<?php echo $teacher['name'];?>"><button type="button" class="btn btn-primary btn-circle btn-xs"><i class="fa fa-edit"></i></button></a>
                            <a href="#" onclick="confirm_modal('<?php echo base_url();?>hrm/teacher/delete/<?php echo $teacher['teacher_id'];?>');"><button type="button" class="btn btn-danger btn-circle btn-xs"><i class="fa fa-times"></i></button></a>
                            ...
                            <a href="<?php echo base_url();?>hrm/printTeacherInformation/<?php echo $teacher['teacher_id'];?>/TeacherName=<?php echo $teacher['name'];?>"><button type="button" class="btn btn-success btn-circle btn-xs"><i class="fa fa-print"></i></button></a>
                            </td>
                        </tr>
