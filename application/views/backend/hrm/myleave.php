...
<div class="row">
	...
	<?php echo form_open(base_url() . 'hrm/myleave/create' , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
        ...
        foreach($leave as $row): ?>
            <tr>
                ...
                <td>
                    ...
                    ?>
					<a onclick="showAjaxModal('<?php echo base_url();?>modal/popup/myleave_reasons/<?php echo $row['leave_code'];?>')" class="btn btn-info btn-sm btn-rounded">Reasons...</a>
                </td>
                <td>
				...
				<a href="#" onclick="showAjaxModal('<?php echo base_url(); ?>modal/popup/leave_edit/<?php echo $row['leave_id']; ?>');" 
                  ...
                  <a href="#" onclick="confirm_modal('<?php echo base_url(); ?>hrm/myleave/delete/<?php echo $row['leave_id']; ?>');" 
