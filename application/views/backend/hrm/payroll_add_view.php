    ...
    <div class="row">
        ...
        <div class="form-group">
                ...
                <select name="employee_id" class="form-control" id="employee_holder" required>
                    <?php
					$user_list = explode('-', $employee_id);
					$user_login_type = $user_list[0];
					$user_login_id = $user_list[1];
					?>		
                  <option value="<?php echo $employee_id;?>"><?php echo $this->db->get_where($user_login_type, 
				  array($user_login_type . '_id' => $user_login_id))->row()->name;?></option>
                       ...
                       <label class="col-md-12" for="example-text"><?php echo get_phrase('basic'); ?></label>
                        ...
                        <div class="col-sm-12">
                            ...
                            <input type="text" class="form-control" name="basic" id="basic"
                                value="<?php echo $this->db->get_where($user_login_type, array($user_login_type . '_id' => $user_login_id))->row()->joining_salary;?>" readonly />
                        </div>
                    </div>
