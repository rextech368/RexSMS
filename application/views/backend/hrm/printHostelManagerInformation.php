<div class="row">
                    <div class="col-sm-12">
				  	<div class="panel panel-info">
                            <div class="panel-heading"> <?php echo get_phrase("hostel's_profile");?>
					...
					<a href="<?php echo base_url();?>hrm/hostel" 
                     class="btn btn-orange btn-xs"><i class="fa fa-plus"></i>&nbsp;<?php echo get_phrase('add_hostel');?>
                    </a>
...
<table class="table" width="1030" border="1">
  ...
  <tr>
    <td width="180" rowspan="4"><img src="<?php echo $this->crud_model->get_image_url('hostel',$row['hostel_id']);?>" alt="user" class="img-thumbnail img-responsive" width="260" height="260"></td>
    <td width="135"><div align="right"><strong>NAME</strong></div></td>
    <td width="671" class="text-uppercase">&nbsp;&nbsp;<?php echo $row ['name']; ?></td>
  </tr>
  <tr>
    <td><div align="right"><strong>HOSTEL NUMBER</strong></div></td>
  ...
  <tr>
  <tr>
    <td><div align="right"><strong>HOSTEL ADDRESS</strong></div></td>
  ...
  <tr>
    <td colspan="3"><div class="alert alert-info">DOWNLOAD FULL DOCUMENTS ABOUT hostel </div>&nbsp;&nbsp;Download Full Document:&nbsp;<a href="<?php echo base_url().'uploads/hostel_image/'.$row['file_name']; ?>"><button type="button" class="btn btn-success btn-circle btn-xs"><i class="fa fa-download"></i></button></a>
	<hr>
	</td>
  </tr>
</table>
