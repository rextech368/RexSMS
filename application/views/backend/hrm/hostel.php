            ...
            <div class="panel-heading">
				&nbsp;
					<div class="pull-right"><a href="#" data-perform="panel-collapse"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add 
						<?php echo get_phrase('New hostel');?> here</a> <a href="#" data-perform="panel-dismiss"></a> 
					</div>
			</div>
				<div class="panel-wrapper collapse out" aria-expanded="true">
                    <div class="panel-body">
					<?php echo form_open(base_url() . 'hrm/hostel/insert/' , 
...
<div class="row">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <a href="<?php echo base_url();?>hrm/printHostelManagerInformation/<?php echo $hostel['hostel_id'];?>/hostelName=<?php echo $hostel['name'];?>"><button type="button" class="btn btn-success btn-circle btn-xs"><i class="fa fa-print"></i></button></a>
                            <a onclick="confirm_modal('<?php echo base_url();?>hrm/hostel/delete/<?php echo $hostel['hostel_id'];?>')" class="btn btn-danger btn-circle btn-xs" style="color:white"><i class="fa fa-times"></i></a>
