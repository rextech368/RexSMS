    ...
    <tbody>
            ...
            <tr>
                ...
                echo '<div class="label label-danger">' . get_phrase('declined') . '</div>';?>
				 <a onclick="showAjaxModal('<?php echo base_url();?>modal/popup/leave_reasons/<?php echo $leave['leave_code'];?>')" class="btn btn-info btn-sm btn-rounded">Reasons...</a>
                </td>
                ...
                <a onclick="confirm_modal('<?php echo base_url();?>hrm/myleave/delete/<?php echo $leave['leave_code'];?>')" class="btn btn-danger btn-circle btn-xs" style="color:white"><i class="fa fa-times"></i></a>
