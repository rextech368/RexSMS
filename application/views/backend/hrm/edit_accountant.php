        ...
        <div class="panel panel-info">
            <div class="panel-heading">
				<?php echo get_phrase('New accountant');?></div>
                        ...
                        <?php echo form_open(base_url() . 'hrm/accountant/update/'. $accountant['accountant_id'] , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
                    ...
                    <div class="col-sm-12">
                            ...
                            <input type="email" name="email" value="<?php echo $accountant['email'];?>" class="form-control" /required>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12">
                            ...
                            <input type="text" name="phone" value="<?php echo $accountant['phone'];?>" class="form-control" /required>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12">
                            ...
                            <input type="text" name="qualification" value="<?php echo $accountant['qualification'];?>" class="form-control" /required>
                        </div>
                    </div>
					...
					<div class="form-group">
						...
						<div class="col-sm-12">
							<input type="date" class="form-control datepicker" name="date_of_joining" value="<?php echo $accountant['date_of_joining'];?>" required>
						</div> 
					</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-12">
						<input type="date" class="form-control datepicker" name="date_of_leaving" value="<?php echo $accountant['date_of_leaving'];?>">
					</div> 
				</div>
				...
				<div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <select name="status" class="form-control select2">
                                <option value="1"<?php if($accountant ['status'] == '1') echo 'selected="selected"';?>><?php echo get_phrase('active'); ?></option>
                                <option value="2"<?php if($accountant ['status'] == '2') echo 'selected="selected"';?>><?php echo get_phrase('inactive'); ?></option>
                            </select>
                        </div> 
                    </div>
                    ...
                    <label class="col-sm-12"><?php echo get_phrase('joining_salary'); ?></label>
                        ...
                        <div class="col-sm-12">
                            <input type="number" class="form-control" name="joining_salary" value="<?php echo $accountant['joining_salary'];?>" required>
                        </div> 
                    </div>
				 ...
				 <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <input type="text" class="form-control" name="account_holder_name" value="<?php echo $accountant['account_holder_name'];?>" required />
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <input type="text" class="form-control" name="account_number" value="<?php echo $accountant['account_number'];?>" required />
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <input type="text" class="form-control" name="bank_name" value="<?php echo $accountant['bank_name'];?>" required>
                        </div> 
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <input type="text" class="form-control" name="branch" value="<?php echo $accountant['branch'];?>" >
                        </div> 
                    </div>
                    ...
                    <div class="col-sm-12">
                            ...
                            <img src="<?php echo  $this->crud_model->get_image_url('accountant', $accountant['accountant_id']) ;?>" width="30" height="30">
                        </div>
                    </div>
    ...
    function get_designation_val(department_id) {
		...
		<script>
			$(document).ready(function() {
				...
				var accountant_id = '<?php echo $param2;?>';
				get_designation_val(department_id,accountant_id);
