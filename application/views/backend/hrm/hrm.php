            ...
            <div class="panel-heading">
				&nbsp;
					<div class="pull-right"><a href="#" data-perform="panel-collapse"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add 
						<?php echo get_phrase('New hrm');?> here</a> <a href="#" data-perform="panel-dismiss"></a> 
					</div>
			</div>
				<div class="panel-wrapper collapse out" aria-expanded="true">
                    <div class="panel-body">
					<?php echo form_open(base_url() . 'hrm/hrm/insert/' , 
...
<div class="row">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <a href="<?php echo base_url();?>hrm/printHumanResourcesInformation/<?php echo $hrm['hrm_id'];?>/hrmName=<?php echo $hrm['name'];?>"><button type="button" class="btn btn-success btn-circle btn-xs"><i class="fa fa-print"></i></button></a>
                            <a onclick="confirm_modal('<?php echo base_url();?>hrm/hrm/delete/<?php echo $hrm['hrm_id'];?>')" class="btn btn-danger btn-circle btn-xs" style="color:white"><i class="fa fa-times"></i></a>
