    ...
    <div class="col-sm-12">
        <div class="panel panel-info">
            <div class="panel-heading">
				<?php echo get_phrase('New hostel');?></div>
                        <div class="panel-body">

                        <?php echo form_open(base_url() . 'hrm/hostel/update/'. $hostel['hostel_id'] , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
                    ...
                    <div class="col-sm-12">
                            ...
                            <input type="email" name="email" value="<?php echo $hostel['email'];?>" class="form-control" /required>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12">
                            ...
                            <input type="text" name="phone" value="<?php echo $hostel['phone'];?>" class="form-control" /required>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12">
                            ...
                            <input type="text" name="qualification" value="<?php echo $hostel['qualification'];?>" class="form-control" /required>
                        </div>
                    </div>
					...
					<div class="form-group">
						...
						<div class="col-sm-12">
							<input type="date" class="form-control datepicker" name="date_of_joining" value="<?php echo $hostel['date_of_joining'];?>" required>
						</div> 
					</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-12">
						<input type="date" class="form-control datepicker" name="date_of_leaving" value="<?php echo $hostel['date_of_leaving'];?>">
					</div> 
				</div>
				...
				<div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <select name="status" class="form-control select2">
                                <option value="1"<?php if($hostel ['status'] == '1') echo 'selected="selected"';?>><?php echo get_phrase('active'); ?></option>
                                <option value="2"<?php if($hostel ['status'] == '2') echo 'selected="selected"';?>><?php echo get_phrase('inactive'); ?></option>
                            </select>
                        </div> 
                    </div>
                    ...
                    <label class="col-sm-12"><?php echo get_phrase('joining_salary'); ?></label>
                        ...
                        <div class="col-sm-12">
                            <input type="number" class="form-control" name="joining_salary" value="<?php echo $hostel['joining_salary'];?>" required>
                        </div> 
                    </div>
				 ...
				 <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <input type="text" class="form-control" name="account_holder_name" value="<?php echo $hostel['account_holder_name'];?>" required />
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <input type="text" class="form-control" name="account_number" value="<?php echo $hostel['account_number'];?>" required />
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <input type="text" class="form-control" name="bank_name" value="<?php echo $hostel['bank_name'];?>" required>
                        </div> 
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <input type="text" class="form-control" name="branch" value="<?php echo $hostel['branch'];?>" >
                        </div> 
                    </div>
                    ...
                    <div class="col-sm-12">
                            ...
                            <img src="<?php echo  $this->crud_model->get_image_url('hostel', $hostel['hostel_id']) ;?>" width="30" height="30">
                        </div>
                    </div>
    ...
    function get_designation_val(department_id) {
		...
		<script>
			$(document).ready(function() {
				...
				get_designation_val(department_id,hostel_id);
