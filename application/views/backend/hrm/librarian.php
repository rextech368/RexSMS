        ...
        <div class="panel panel-default">
            <div class="panel-heading">
				...
				<div class="panel-wrapper collapse out" aria-expanded="true">
					...
					<?php echo form_open(base_url() . 'hrm/librarian/insert/' , 
...
<div class="row">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <a href="<?php echo base_url();?>hrm/printLibrarianInformation/<?php echo $librarian['librarian_id'];?>/LibrarianName=<?php echo $librarian['name'];?>"><button type="button" class="btn btn-success btn-circle btn-xs"><i class="fa fa-print"></i></button></a>
                            <a onclick="confirm_modal('<?php echo base_url();?>hrm/librarian/delete/<?php echo $librarian['librarian_id'];?>')" class="btn btn-danger btn-circle btn-xs" style="color:white"><i class="fa fa-times"></i></a>
