<div class="row">
                    <div class="col-sm-12">
				  	<div class="panel panel-info">
                            <div class="panel-heading"> <?php echo get_phrase("teacher's_profile");?>
					...
					<a href="<?php echo base_url();?>admin/teacher" 
                     class="btn btn-orange btn-xs"><i class="fa fa-plus"></i>&nbsp;<?php echo get_phrase('add_teacher');?>
                    </a>
...
<table class="table" width="1030" border="1">
  ...
  <tr>
    <td><div align="right"><strong>TEACHER NUMBER</strong></div></td>
  ...
  <tr>
   ...
   <tr>
    <td><div align="right"><strong>TEACHER ROLE</strong></div></td>
     <td colspan="2">
  ...
  <tr>
  <tr>
    <td><div align="right"><strong>TEACHER ADDRESS</strong></div></td>
