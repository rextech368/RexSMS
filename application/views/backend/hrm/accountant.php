        ...
        <div class="panel panel-default">
            <div class="panel-heading">
				...
				<div class="panel-wrapper collapse out" aria-expanded="true">
					...
					<?php echo form_open(base_url() . 'hrm/accountant/insert/' , 
...
<div class="row">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <a href="<?php echo base_url();?>hrm/printAccountantInformation/<?php echo $accountant['accountant_id'];?>/accountantName=<?php echo $accountant['name'];?>"><button type="button" class="btn btn-success btn-circle btn-xs"><i class="fa fa-print"></i></button></a>
                            <a onclick="confirm_modal('<?php echo base_url();?>hrm/accountant/delete/<?php echo $accountant['accountant_id'];?>')" class="btn btn-danger btn-circle btn-xs" style="color:white"><i class="fa fa-times"></i></a>
