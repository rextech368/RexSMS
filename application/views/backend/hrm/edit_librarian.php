        ...
        <div class="panel panel-info">
            <div class="panel-heading">
				<?php echo get_phrase('New Librarian');?></div>
                        ...
                        <?php echo form_open(base_url() . 'hrm/librarian/update/'. $librarian['librarian_id'] , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
