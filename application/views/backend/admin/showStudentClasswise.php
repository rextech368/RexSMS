...
<a href="<?php echo base_url(); ?>admin/view_student/<?php echo $student['student_id'];?>/"> <button type="button" class="btn btn-success btn-circle btn-xs"><i class="fa fa-link"></i></button></a>	
...
<a href="#" onclick="quarantine_modal('<?php echo base_url();?>admin/quarantine/<?php echo $student['student_id'];?>');"><button type="button" class="btn btn-danger btn-sm"><i class="fa fa-lock"></i> <?=get_phrase('quarantine')?></button></a> 
...
<table id="example23" class="table display">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo $this->crud_model->get_type_name_by_id('class', $student['class_id']);?></td>
							<td><?php echo $student['sex'];?></td>
                            <td><?php echo $this->crud_model->get_type_name_by_id('student', $student['section']);?></td>
                            <td><?php echo $student['email'];?></td>
                            <td><?php echo $student['phone'];?></td>
