                    ...
                    <tbody>
					 ...
					 <?php $select = $this->live_class_model->selectLiveClassInformationByUser();
                        ...
                        <tr>
							...
							<a href="<?php echo base_url();?>admin/host_live_class/<?php echo $row['live_class_id'];?>"><button type="button" class="btn btn-success btn-rounded btn-sm"><i class="fa fa-youtube-play"></i> start streaming</button></a>
							
							
                            <a href="#" onclick="confirm_modal('<?php echo base_url();?>admin/live_class/delete/<?php echo $row['live_class_id'];?>');"><button type="button" class="btn btn-danger btn-rounded btn-sm"><i class="fa fa-times"></i> delete</button></a>
