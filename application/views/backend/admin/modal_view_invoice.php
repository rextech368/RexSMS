...
<button onclick="printInvoice('#invoice_print')" class="btn btn-rounded btn-success btn-sm"><i class="fa fa-print"></i>&nbsp;Print</button>
            ...
            <tbody>
                ...
                foreach ($payment_history as $row2):
                    ...
                    <tr>
                        ...
                        <?php 
					            		if ($row2['method'] == 1)
					            			echo get_phrase('Bank1');
					            		if ($row2['method'] == 2)
					            			echo get_phrase('Bank 2');
					            		if ($row2['method'] == 3)
					            			echo get_phrase('Bank 3');
...
<script type="text/javascript">
    ...
    function printInvoice(elem) {
        if (printWindow === null || printWindow.closed) {
            ...
            printWindow = window.open('', 'PRINT', 'height=400,width=800');
