		...
		<div class="panel panel-info">
            <div class="panel-heading"> <i class="fa fa-plus"></i>&nbsp;&nbsp;<?php echo get_phrase('enter_student_score'); ?></div>
                <div class="panel-body table-responsive">
								...
								<thead>
                    				...
                    				<tbody>
										...
										<tr>
											...
											<td>
												<input type="text" class="exam_score form-control" value="<?php echo $general_select['comment'];?>" 
												name="comment_<?php echo $class_subject_exam_student['subject_id'];?>">
											</td>
						...
						<h5 id="error_message" class="alert alert-red" style="display:none">CA score must not be greater 40 and exam score must not be greater than 60</h5>
						<table cellpadding="0" cellspacing="0" border="0" class="table">
								<thead>
									<tr>
										<td><?php echo get_phrase('subject');?></td>
