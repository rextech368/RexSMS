...
<!----CREATION FORM STARTS---->
			...
			<div class="form-group">
                 	<label class="col-md-12" for="example-text"><?php echo get_phrase('colour');?> <b style="color:red">*</b></label>
                    <div class="col-sm-12">
            ...
            <div class="form-group">
                 	<label class="col-md-12" for="example-text"><?php echo get_phrase('icon_picker');?> <b style="color:red">*</b></label>
                    <div class="col-sm-12">
                ...
                <div class="form-group">
                 	<label class="col-md-12" for="example-text"><?php echo get_phrase('Student Club');?> <b style="color:red">*</b></label>
                    <div class="col-sm-12">
