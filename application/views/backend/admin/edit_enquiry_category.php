...
<?php echo form_open(base_url().'admin/enquiry_category/update/'. $category['enquiry_category_id'], array('class' => 'form-horizontal form-groups-bordered validate', 'enctype'=>'multipart/form-data'));?>
                    ...
                    <div class="col-sm-12">
                            <input type="text" name="category" value="<?php echo $category['category'];?>" class="form-control" / required>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12">
                            ...
                            <input type="text" name="purpose" value="<?php echo $category['purpose'];?>" class="form-control" /required>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12">
                            ...
                            <input type="text" name="whom" value="<?php echo $category['whom'];?>" class="form-control" /required >
                        </div>
                    </div>
