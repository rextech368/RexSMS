...
<!----CREATION FORM STARTS---->
					...
					<div class="form-group">
                 	<label class="col-md-12" for="example-text"><?php echo get_phrase('section');?> <b style="color:red">*</b></label>
                    <div class="col-sm-12">
                 ...
                 <div class="form-group">
                    ...
                    <div class="col-sm-12">
                    <input type="date" class="form-control datepicker" id="attDate" name="timestamp" data-format="dd-mm-yyyy" value="<?php echo $date."-".$month."-".$year ;?>" required>
                  </div>
                 </div>
