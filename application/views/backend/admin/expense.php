...
<div class="row">
    <div class="col-sm-12">
        <div class="panel panel-info">
            <div class="panel-heading"> 
                <i class="fa fa-list"></i>&nbsp;&nbsp;<?php echo get_phrase('list_expenses');?>
            </div>
            <div class="panel-wrapper collapse in" aria-expanded="true">
                <div class="panel-body table-responsive">
                    <table id="example23" class="display nowrap" cellspacing="0" width="100%">
                        <thead>
                            <tr>
                                ...
                                <th><div>P.F. (3.70%)</div></th>
                                <th><div>A.T (1.75%)</div></th>
                                <th><div>P.V.I.D (8.4%)</div></th>
                                <th><div>Total Deduction</div></th>
                            </tr>
                        </thead>
                        <tbody>
                        ...
                        foreach ($expenses as $index => $expense): 
                            ...
                            <tr>
                                ...
                                <td><?php echo htmlspecialchars($expense['teacher_name']); ?></td> <!-- Assuming teacher name is used -->
                                <td><?php echo number_format($salary, 2); ?></td>

                                <?php 
                                // Calculate deductions
                                $pf = number_format($salary * 0.037, 2);
                                $at = number_format($salary * 0.0175, 2);
                                $pvid = number_format($salary * 0.084, 2);
                                ?>
                                
                                <td><?php echo htmlspecialchars($pf); ?></td>
                                <td><?php echo htmlspecialchars($at); ?></td>
                                <td><?php echo htmlspecialchars($pvid); ?></td>
                                <td><?php echo number_format(($salary - ($pf + $at + $pvid)), 2); ?></td> <!-- Total Deduction -->
                            </tr>
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <td><?php echo htmlspecialchars($totals['total_salary']); ?></td>
                                <td><?php echo htmlspecialchars($totals['total_pf']); ?></td>
                                <td><?php echo htmlspecialchars($totals['total_at']); ?></td>
                                <td><?php echo htmlspecialchars($totals['total_pvid']); ?></td>
                                <td><?php echo htmlspecialchars($totals['total_deduction']); ?></td>
                            </tr>
                        </tfoot>
                    </table>
                </div>
