        ...
        <div class="panel panel-default">
            <div class="panel-heading">
				...
				<div class="panel-wrapper collapse out" aria-expanded="true">
					...
					<?php echo form_open(base_url() . 'admin/hostel/insert/' , 
...
<div class="row">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <a href="<?php echo base_url();?>admin/printHostelManagerInformation/<?php echo $hostel['hostel_id'];?>/hostelName=<?php echo $hostel['name'];?>"><button type="button" class="btn btn-success btn-circle btn-xs"><i class="fa fa-print"></i></button></a>
