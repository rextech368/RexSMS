...
<!----CREATION FORM STARTS---->
	...
	<div class="form-group">
                 	<label class="col-md-12" for="example-text"><?php echo get_phrase('circular_title');?> <b style="color:red">*</b></label>
                    <div class="col-sm-12">
							...
							<div class="form-group">
                 	<label class="col-md-12" for="example-text"><?php echo get_phrase('reference_no');?> <b style="color:red">*</b></label>
                    <div class="col-sm-12">
                    ...
                    <div class="col-sm-12">
							...
							<div class="form-group">
                 	<label class="col-md-12" for="example-text"><?php echo get_phrase('circular_date');?> <b style="color:red">*</b></label>
                    <div class="col-sm-12">
