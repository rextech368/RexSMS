         ...
         <div class="panel-body table-responsive">
            ...
            <div class="form-group">
               ...
               <div class="form-group">
                  ...
                  <div class="col-sm-12">
                     <input type="text" class="form-control" name="coefficient" value="<?php echo $subject['coefficient'];?>">
                  </div>
               </div>
            ...
            <div class="form-group">
               <button type="submit" class="btn btn-info btn-block btn-rounded btn-sm"><i class="fa fa-edit"></i>&nbsp;<?php echo get_phrase('save');?></button>
            </div>
            </form>                
         </div>
      </div>
