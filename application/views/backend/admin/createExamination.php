...
<?php echo form_open(base_url() . 'admin/createExamination/create', array('class' => 'form-horizontal form-goups-bordered validate'));?>
			...
			<div class="alert alert-info">Ensure you set current term and session in system settings before creating new exam. Check your current term and session
				...
				<div class="form-group">
                 	<label class="col-md-12" for="example-text"><?php echo get_phrase('is_this_terminal_exam');?></label>
                    	<div class="col-sm-12">
				...
				<div class="alert alert-danger">Ensure you save all normal test or exam first before saving terminal exam because terminal exam should be saved last for the same session and term.</div>
...
<div class="panel-wrapper collapse in" aria-expanded="true">
				...
				<thead>
                		...
                		<tr>
							...
							<?php if(get_settings('report_template') == 'tanzania'):?>
							<th><div><?php echo get_phrase('terminal_exam');?></div></th>
							<?php endif;?>
                    ...
                    foreach ($exams as $key => $exam): ?>
                        <tr>
							...
							<?php 
								if($exam['terminal'] == 1)
								echo 'This is Terminal Exam';
								else
								echo 'Normal Test / Exam';
							?>		
							</td>
							<?php endif;?>
