        ...
        <div class="panel panel-default">
            <div class="panel-heading"><i class="fa fa-plus"></i>&nbsp;
                <div class="pull-right"><a href="#" data-perform="panel-collapse"><i
                            class="fa fa-plus"></i>&nbsp;&nbsp;ADD NEW supplier HERE</a> <a href="#"
            ...
            <div class="panel-wrapper collapse out" aria-expanded="true">
                <div class="panel-body">
                    ...
                    <?php echo form_open(base_url() . 'inventory/supplier/create/' , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
                    ...
                    <div class="form-group">
                        <label class="col-md-12" for="example-text"><?php echo get_phrase('address');?> <b
                                style="color:red">*</b></label>
                        <div class="col-sm-12">
                    ...
                    <div class="form-group">
                        <label class="col-md-12" for="example-text"><?php echo get_phrase('city');?> <b
                                style="color:red">*</b></label>
                        <div class="col-sm-12">
                    ...
                    <div class="form-group">
                        <label class="col-md-12" for="example-text"><?php echo get_phrase('state');?> <b
                                style="color:red">*</b></label>
                        <div class="col-sm-12">
                    ...
                    <div class="form-group">
                        <label class="col-md-12" for="example-text">Select Country <b style="color:red">*</b></label>
                        <div class="col-sm-12">
                    ...
                    <div class="form-group">
                        <label class="col-md-12" for="example-text"><?php echo get_phrase('company_name');?> <b
                                style="color:red">*</b></label>
                        <div class="col-sm-12">
                    ...
                    <div class="form-group">
                        <button type="submit" name="submit" class="btn btn-info btn-block btn-rounded btn-sm"> <i
                                class="fa fa-plus"></i>&nbsp;<?php echo get_phrase('add_supplier');?></button>
    ...
    <div class="col-sm-12">
        <div class="panel panel-info">
            ...
            <div class="panel-body table-responsive">
                <?php echo get_phrase('list_suppliers');?>
                <hr>
                ...
                <table id="example23" class="display nowrap" cellspacing="0" width="100%">
                    <thead>
                        <tr>
                            ...
                            <th>
                                <div><?php echo get_phrase('city');?></div>
                            </th>
                            <th>
                                <div><?php echo get_phrase('state');?></div>
                            </th>
                            <th>
                                <div><?php echo get_phrase('country');?></div>
                            </th>
                            <th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="#"
                                    onclick="showAjaxModal('<?php echo base_url();?>modal/popup/edit_supplier_info/<?php echo $row['supplier_id'];?>');"
                                    class="btn btn-info btn-circle btn-sm" style="color:white"><i
                                        class="fa fa-edit"></i></a>

                                <a href="#"
                                    onclick="confirm_modal('<?php echo base_url();?>inventory/supplier/delete/<?php echo $row['supplier_id'];?>');"><button
                                        type="button" class="btn btn-danger btn-circle btn-xs"><i
                                            class="fa fa-times"></i></button></a>

                                <a href="#"
                                    onclick="showAjaxModal('<?php echo base_url();?>modal/popup/view_supplier_info/<?php echo $row['supplier_id'];?>');"
