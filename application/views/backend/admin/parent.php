    ...
    <div class="col-sm-12">
        <div class="panel panel-info">
            <div class="panel-heading">
				<a onclick="showAjaxModal('<?php echo base_url();?>modal/popup/bulk_parent/')" class="btn btn-info btn-sm btn-rounded"><i class="fa fa-upload"></i> <?php echo get_phrase('bulk_parent_upload');?></a>
...
<?php echo form_open(base_url().'admin/parent/insert', array('class' => 'form-horizontal form-groups-bordered validate', 'enctype'=>'multipart/form-data'));?>
                    ...
                    <div class="form-group">
                 	<label class="col-md-12" for="example-text"><?php echo get_phrase ('Profession');?> <b style="color:red">*</b></label>
                    <div class="col-sm-12">
...
<div class="row">
                    <div class="col-sm-12">
				  	<div class="panel panel-info">
                            <div class="panel-heading"><i class="fa fa-list"></i>&nbsp; <?php echo get_phrase('list_parent');?></div>
