            ...
            <div class="kingster-page-title-wrap  kingster-style-medium kingster-left-align">
                ...
                <div class="kingster-page-title-container kingster-container">
                    <div class="kingster-page-title-content kingster-item-pdlr">
                        <h1 class="kingster-page-title"><?=get_phrase('admission_procedures')?></h1></div>
                </div>
            </div>
                                    ...
                                    <article id="post-1268" class="post-1268 post type-post status-publish format-standard has-post-thumbnail hentry category-blog category-post-format tag-news">
                                        <div class="kingster-single-article clearfix">
                                            <div class="kingster-single-article-content">
												...
												<p align="justify">
													<?=$this->db->get_where('more_about', array('id' => '1'))->row()->apply;?>
													<hr>
												 <div class="gdlr-core-button-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align">
													 <a class="gdlr-core-button  gdlr-core-button-solid gdlr-core-button-no-border pull-right" 
													 href="<?=base_url()?>applicationForm/index/validate" id="a_1dd7_0"><span class="gdlr-core-content" ><?=get_phrase('apply_now');?></span></a>
												 </div>
												</p>
                                            </div>
                                        </div>
