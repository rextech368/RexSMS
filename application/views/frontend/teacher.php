            ...
            <div class="kingster-page-title-wrap  kingster-style-medium kingster-left-align">
                ...
                <div class="kingster-page-title-container kingster-container">
                    <div class="kingster-page-title-content kingster-item-pdlr">
                        <h1 class="kingster-page-title"><?=get_phrase('teaching_staff')?></h1></div>
                </div>
            </div>
                                        ...
                                        <div class="kingster-single-article clearfix">
                                            ...
                                            <div class="gdlr-core-event-item-list gdlr-core-style-grid gdlr-core-item-pdlr gdlr-core-column-20  clearfix" style="margin-bottom: 45px ;">
												...
												<style>
                                                    ...
                                                    <a href="<?=base_url().'uploads/teacher_image/'.$row['teacher_id'].'.jpg'?>" id="size" data-lightbox-group="gdlr-core-img-group-1" class="gdlr-core-lightgallery gdlr-core-js" ><img src="<?=base_url().'uploads/teacher_image/'.$row['teacher_id'].'.jpg'?>" id="size"></a>
                                                ...
                                                <div class="gdlr-core-event-item-content-wrap">
                                                    ...
                                                    <div class="gdlr-core-event-item-info-wrap"><span class="gdlr-core-event-item-info gdlr-core-type-time"><span class="gdlr-core-head" ></span><span class="gdlr-core-tail"><strong>Department:</strong> <?=$this->crud_model->get_type_name_by_id('department', $row['department_id'])?></span></span>
                                                    </div>
                                                </div>
                                            </div>
