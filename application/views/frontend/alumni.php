            ...
            <div class="kingster-page-title-wrap  kingster-style-medium kingster-left-align">
                ...
                <div class="kingster-page-title-container kingster-container">
                    <div class="kingster-page-title-content kingster-item-pdlr">
                        <h1 class="kingster-page-title"><?=get_phrase('alumni')?></h1></div>
                </div>
            </div>
                                ...
                                <div class="kingster-content-area">
                                        <div class="kingster-single-article clearfix">
                                            <div class="kingster-single-article-content">
												...
												<?php
												  $this->db->order_by('alumni_id', 'RANDOM');
												  $query = $this->db->get('alumni', $per_page, $this->uri->segment(3));
                                            ...
                                            <div class="gdlr-core-event-item-list gdlr-core-style-grid gdlr-core-item-pdlr gdlr-core-column-20  clearfix" style="margin-bottom: 45px ;">
												...
												<style>
                                                    ...
                                                    <a href="<?=base_url().'uploads/alumni_image/'.$row['alumni_id'].'.jpg'?>" data-lightbox-group="gdlr-core-img-group-1" class="gdlr-core-lightgallery gdlr-core-js" ><img src="<?=base_url().'uploads/alumni_image/'.$row['alumni_id'].'.jpg'?>" id="size"></a>
                                                ...
                                                <div class="gdlr-core-event-item-content-wrap">
                                                    ...
                                                    <div class="gdlr-core-event-item-info-wrap"><span class="gdlr-core-event-item-info gdlr-core-type-time"><span class="gdlr-core-head" ></span><span class="gdlr-core-tail"><strong>Profession:</strong> <?=$row['profession']?></span></span>
                                                    </div>
                                                </div>
                                            </div>
